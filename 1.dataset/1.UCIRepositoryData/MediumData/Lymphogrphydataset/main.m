...
title('Lymphography - Medium Data')
xlabel('Iteration');
...
display(['The best solution obtained by GWO is : ', num2str(-Best_pos1)]);
display(['The best optimal value of the objective funciton found by GWO is : ', num2str(-Best_score1)]);
display(['The best solution obtained by GWO is : ', num2str(-Alpha_pos1)]);
display(['The best optimal value of the objective funciton found by GWO is : ', num2str(-Alpha_score1)]);
