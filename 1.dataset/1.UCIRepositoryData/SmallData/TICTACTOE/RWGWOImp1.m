function [Alpha_score,Alpha_pos,Convergence_curve1]=RWGWOImp1(SearchAgents_no,Max_iter,lb,ub,dim,fobj)
...
Positions1=RWGWOintialization(SearchAgents_no,dim,ub,lb);
    ...
    for i=1:size(Positions,1)
        for j=1:size(Positions,2)     
            ...
            Positions(i,j)=(X1+X2+X3)/3;% Equation (3.7)
             if Positions(i,j)<Positions1(i,j)
